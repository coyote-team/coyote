...
#                api_memberships GET    /api/v1/organizations/:organization_id/memberships(.:format)                             api/memberships#index
#                                POST   /api/v1/organizations/:organization_id/memberships(.:format)                             api/memberships#create
#                 api_membership PATCH  /api/v1/organizations/:organization_id/memberships/:id(.:format)                         api/memberships#update
#                                PUT    /api/v1/organizations/:organization_id/memberships/:id(.:format)                         api/memberships#update
#                                DELETE /api/v1/organizations/:organization_id/memberships/:id(.:format)                         api/memberships#destroy
...
#                  api_heartbeat GET    /api/v1/heartbeat(.:format)                                                              api/heartbeat#show
...
#          update_many_resources POST   /organizations/:organization_id/resources/update_many(.:format)                          resources#update_many
...
#         impersonate_staff_user GET    /staff/users/:id/impersonate(.:format)                                                   staff/users#impersonate
# stop_impersonating_staff_users GET    /staff/users/stop_impersonating(.:format)                                                staff/users#stop_impersonating

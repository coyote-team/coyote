Plate::Application.configure do
  ...
  #config.assets.precompile += %w( search.js coyote_producer.js coyote_consumer.js coyote_bookmarklet.js)
  ...
  config.action_mailer.default_url_options = { :host => 'coyote.mcachicago.org' }

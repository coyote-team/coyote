...
All API endppoints expect <code>.json</code> as an ending.  You can hit the endpoints when you have logged in.  Otherwise, you can find your user token in the regular site footer after you have logged in and then you can use request headers:

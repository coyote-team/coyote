...
Coyote's API is based on the [JSON API standard](http://jsonapi.org/). Coyote-specific documentation is generated by [apipie](https://github.com/Apipie/apipie-rails) and can be viewed [here](api/).

...
class OrganizationsController < ApplicationController
  before_action :set_current_organization, only: %i[delete destroy show edit update] # helps avoid scenario where ActionView::Template::Error can swallow ActiveRecord::RecordNotFound, when a user is not a member of an org
  ...
  # GET /organizations
  def index
    self.organizations = organization_scope
  end

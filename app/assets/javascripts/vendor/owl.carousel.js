    ...
    var Carousel = {
        ...
        lazyLoad : function () {
            ...
            for (i = 0; i < base.itemsAmount; i += 1) {
                ...
                if (typeof $lazyImg.data("original") !== "string") {
        ...
        lazyPreload : function ($item, $lazyImg) {
            ...
            if ($lazyImg.prop("tagName") === "DIV") {
                $lazyImg.css("background-image", "url(" + $lazyImg.data("original") + ")");
                isBackgroundImg = true;
            } else {
                $lazyImg[0].src = $lazyImg.data("original");
            }

            function showImage() {
                $item.data("owl-loaded", "loaded").removeClass("loading");
                $lazyImg.removeAttr("data-original");

...
FactoryBot.create(:representation,resource: resource,metum: short_metum,text: alt_text,endpoint: endpoints.first)
FactoryBot.create(:representation,resource: resource,metum: long_metum,text: long_text,endpoint: endpoints.first)
